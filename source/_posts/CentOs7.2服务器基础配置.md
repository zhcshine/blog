...
[参考链接](https://www.digitalocean.com/community/tutorials/how-to-install-linux-nginx-mysql-php-lemp-stack-on-centos-7) 
...
server { 
    listen 80; server\_name server\_domain\_name\_or_IP; # 注意位置，在括号外 root /usr/share/nginx/html; index index.php index.html index.htm;
...
{% post_link Docker入门基础 %}

## Sentry

{% post_link Sentry入门基础 %}

## RabbitMQ

{% post_link RabbitMq入门基础 %}

## PostgresSql

{% post_link PostgresSql入门基础 %}
